...
Traceback (most recent call last):
  ...
  File "/home/iida/git/agentic-ni/src/agentic_ni/tools/pyats_tools.py", line 84, in build_testbed
    lab = _get_lab(client, lab_id)
  File "/home/iida/git/agentic-ni/src/agentic_ni/tools/cml_tools.py", line 106, in _get_lab
    client.join_existing_labs()
    ^^^^^^^^^^^^^^^^^^^^^^^^^
AttributeError: 'ClientLibrary' object has no attribute 'join_existing_labs'. Did you mean: 'join_existing_lab'?
During task with name 'validator' and id '473b15f4-78bc-edbe-3154-aeb2eb3b266d'
